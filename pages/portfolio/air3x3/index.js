...
import styl from "./air3x3.module.scss"
  ...
  return (
    <>
      <div className={styl.container}>
        ...
        <section className={styl.landing}>
          <div>
            <h1>
              Air 3x3
        ...
        <section className={styl.problem}>
          <div>
        ...
        <section className={styl.objectives}>
          <div>
        ...
        <div className={styl.screenshots}>
          <h2>Screenshots</h2>
          <section className={styl.screenshot}>
